...
describe('ModalAddDeck', () => {
  ...
  let mockAddDeck: ReturnType<typeof vi.fn>;
  ...
  it('should render correctly when open', () => {
    render(<ModalAddDeck isOpen={true} closeModal={mockCloseModal} addDeck={mockAddDeck} />);
  ...
  it('should allow typing in the input field', () => {
    ...
    const input = screen.getByPlaceholderText('Nuevo nombre de deck') as HTMLInputElement;
